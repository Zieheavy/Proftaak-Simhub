...
void setup(){
  ...
  smooth();
  background(0);
  img=loadImage("background1080_200revb.png");
  // Arduino connection
...
void gameDataOutput(float tTime, float lapTime, float speed, float gear, float cLap, float rpm, float wspFL){
